...
function Viewnode() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.coingecko.com/api/v3/simple/price?ids=${coinId}&vs_currencies=${currency}&include_24hr_change=${hours_24}`,
        {}
      )
      .then((response) => {
    ...
    axios
      .get(`https://api.coingecko.com/api/v3/search?query=${coinId}`, {})
      .then((response) => {
      ...
      <div className="border-b-2 mb-2">
        <div className="flex gap-2 mb-[2rem] ">
          ...
          <div className=" flex gap-2 text-lg font-medium">
            ...
            <div className="text-[#5D667B] font-bold text-sm mt-auto mb-auto">
              {symbol}
            </div>
          </div>
        ...
        <div className="flex gap-4 mb-4 ">
          ...
          <div className="flex gap-5 sm:justify-between">
            ...
            <div className="text-[#768396] text-sm">(24H)</div>
          </div>
        </div>
      </div>
